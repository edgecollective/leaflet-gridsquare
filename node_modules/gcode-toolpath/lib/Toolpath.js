...
var _gcodeInterpreter = require('gcode-interpreter');

var _gcodeInterpreter2 = _interopRequireDefault(_gcodeInterpreter);
...
var Toolpath = function () {
    ...
    function Toolpath(options) {
        ...
        this.offsetAddLine = function (start, end) {
            _this.fn.addLine(_this.modal, _this.offsetG92(start), _this.offsetG92(end));
        };

        this.offsetAddArcCurve = function (start, end, center) {
            _this.fn.addArcCurve(_this.modal, _this.offsetG92(start), _this.offsetG92(end), _this.offsetG92(center));
        };
        ...
        this.handlers = {
            ...
            'G2': function G2(params) {
                ...
                _this.offsetAddArcCurve(v1, v2, v0);
        ...
        var toolpath = new _gcodeInterpreter2.default({ handlers: this.handlers });
    ...
    _createClass(Toolpath, [{
        ...
        value: function setPosition() {
            ...
            if (_typeof(pos[0]) === 'object') {
                ...
                this.position.x = typeof _x2 === 'number' ? _x2 : this.position.x;
