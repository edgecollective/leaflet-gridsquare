...
var RC_FILE = '.cncrc';
var SESSION_PATH = '.cncjs-sessions'; // Secret

var secret = _package["default"].version;
...
var _default = {
  rcfile: _path["default"].resolve(getUserHome(), RC_FILE),
  verbosity: 0,
  ...
  middleware: {
    ...
    'session': {
      path: _path["default"].resolve(getUserHome(), SESSION_PATH)
    }
  },
  siofu: {
  ...
  i18next: {
    ...
    backend: {
      ...
      loadPath: _path["default"].resolve(__dirname, '..', 'i18n', '{{lng}}', '{{ns}}.json'),
      // path to post missing resources
      addPath: _path["default"].resolve(__dirname, '..', 'i18n', '{{lng}}', '{{ns}}.savedMissing.json'),
