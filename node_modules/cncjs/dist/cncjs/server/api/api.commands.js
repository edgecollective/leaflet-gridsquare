...
exports.update = exports.run = exports.read = exports.fetch = exports.create = exports.__delete = void 0;
...
var log = (0, _logger["default"])('api:commands');
...
var run = function run(req, res) {
  ...
  var taskId = _taskrunner["default"].run(commands, title);
